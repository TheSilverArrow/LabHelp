...
TB CS (Sputum)|Sputum|N/A|Microbiology
GeneXpert (Sputum)|Sputum|N/A|MRL
TB PCR (Sputum)|Sputum|N/A|MRL
MTB-RIF (Sputum)|Sputum|N/A|MRL
GS/CS (Sputum)|Sputum|N/A|Microbiology
...
GeneXpert (ETA)|ETA|N/A|MRL
TB PCR (ETA)|ETA|N/A|MRL
MTB-RIF (ETA)|ETA|N/A|MRL
ETA TB CS|ETA|N/A|Microbiology
...
export const RENDER_FIELDS = [
  { class: 'patient-name', key: 'name', title: 'NAME', defaultFontSize: 20 },
  { class: 'ward-location', key: 'ward_location', title: 'WARD/LOCATION', defaultFontSize: 20 },
  { class: 'case-number', key: 'case_number', title: 'CASE NO.', defaultFontSize: 20 },
  { class: 'birthday', key: 'birthday', title: 'BIRTH DATE', defaultFontSize: 20 },
  { class: 'diagnosis', key: 'diagnosis', title: 'DIAGNOSIS', element: 'textarea', defaultFontSize: 20, isMultiLine: true },
  { class: 'requested-by', key: 'requested_by', title: 'REQUESTED BY', defaultFontSize: 20 },
  { class: 'collected-by', key: 'collected_by', title: 'COLLECTED BY', defaultFontSize: 20 },
  { class: 'date-collected', key: 'date_collected', title: 'DATE COLLECTED', defaultFontSize: 20 },
  { class: 'time-collected', key: 'time_collected', title: 'TIME COLLECTED', defaultFontSize: 20 },
  { class: 'specimen-type', key: 'specimen_type', title: 'SPECIMEN TYPE', defaultFontSize: 20 },
  { class: 'site-of-collection', key: 'site_of_collection', title: 'SITE OF COLLECTION', defaultFontSize: 20 },
  { class: 'age-sex-age', defaultFontSize: 20 },
  { class: 'age-sex-sex', defaultFontSize: 20 },
  { class: 'requests-field', defaultFontSize: 22, isMultiLine: true },
];
